            ...
            <div class="row">
                <div class="col-8 form-inner-cont">
                    ...
                    <form action="{{URL('admin/book/update/'. $book->id)}}" method="post" class="signin-form" enctype="multipart/form-data" id="Add-New-Book">
                        ...
                        <div class="form-group form-input">
                            <input type="number" name="published_year" value="{{ $book->published_year }}" id="w3lSubject" class="form-control" placeholder="Enter published year " min="1990" max="2021">
                        </div>
                        <div class="form-group form-input">
                            <input type="number" name="published_number" value="{{ $book->published_number }}" id="w3lSender" class="form-control" placeholder="Enter published number">
                        </div>
                        <div class="form-input">
                            <textarea name="description" value="" id="w3lMessage" placeholder="Enter description about book">{{ $book->description }}</textarea>
                        </div>
